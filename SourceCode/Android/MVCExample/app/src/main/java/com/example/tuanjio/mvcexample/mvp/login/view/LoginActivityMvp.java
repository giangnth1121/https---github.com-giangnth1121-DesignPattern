...
import com.example.tuanjio.mvcexample.mvp.login.presenter.PresenterLogin;
...
public class LoginActivityMvp extends AppCompatActivity implements ViewLoginSimple {
    ...
    private void init() {
        tvTitle.setText("Kiến trúc MVP");
        mPresenter = PresenterLogin.getInstance(this);
    }
